	...
	<div class="content-wrapper">
		...
		<div class="content-header">
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						<h1 class="m-0">Website Visitors</h1>
					</div><!-- /.col -->
					<div class="col-sm-6">
		        ...
		        <div class="row">
			        	...
			        	<div class="card">
			        		...
			        		<div class="card-body">
			        			<table id="visitorsTable" class="table table-bordered table-striped">
    								...
    								<tbody>
    									@foreach($websiteVisitors as $websiteVisitorsData)
										<tr>
											<td>{{$websiteVisitorsData->id}}</td>
											<td>{{$websiteVisitorsData->name}}</td>
											<td>{{$websiteVisitorsData->purpose}}</td>
											<td>{{$websiteVisitorsData->no_of_visits}}</td>
											<td>{{$websiteVisitorsData->created_at}}</td>
										</tr>
										@endforeach
    								</tbody>
    							</table>
			        ...
			        <div class="col-md-3">
			        	<div class="card">
			        		...
			        		<div class="card-body">
			        			<br>
			        			<form action="/main/view-all-visitors-website" method="GET">
		        					@csrf
		        				...
		        				<a href="/main/view-all-visitors-website" class="btn btn-default btn-block">Reset</a>
